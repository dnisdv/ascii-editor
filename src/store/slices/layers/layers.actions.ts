...
export const addLayer = createDocumentScopedThunk<
  ILayerModel,
  ILayerModel
>(
  'layers/addLayer',
...
export const addLayerAndActivate = createDocumentScopedThunk<
  ILayerModel,
  ILayerModel
>(
...
export const removeLayer = createDocumentScopedThunk<
  string,
  { id: string }
>(
  'layers/removeLayer',
...
export const setActiveLayer = createDocumentScopedThunk<
  string,
  { id: string }
>(
...
>(
  'layers/setTileData',
  ({ x, y, layerId, documentId }) => {
    DocumentsApi.withDocument(documentId).removeTile(layerId, x, y)
  }
);

export const silentSetLayer = createDocumentScopedThunk<
  ILayerModel,
  ILayerModel
>(
...
export const silentSetLayers = createDocumentScopedThunk<
  ...
  { data: Record<string, ILayerModel> }
>(
  'layers/silentSetLayers',
  ({ data }) => {
    return data;
  }
);

export const silentSetActiveLayer = createDocumentScopedThunk<
  string,
  { id: string }
>(
