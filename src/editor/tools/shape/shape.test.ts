...
describe('DrawShapeTool', () => {
  ...
  const performShapeDraw = (
    ...
    selectCanvasElement.dispatchEvent(createMouseEvent('mousedown', startClientCoords.x, startClientCoords.y, button));
    selectCanvasElement.dispatchEvent(createMouseEvent('mousemove', endClientCoords.x, endClientCoords.y, button));
    selectCanvasElement.dispatchEvent(createMouseEvent('mouseup', endClientCoords.x, endClientCoords.y, button));
  };
...
│`);
  ...
  it('should cancel drawing if the active layer becomes invisible during a drag', () => {
    ...
    selectCanvasElement.dispatchEvent(createMouseEvent('mousedown', startClientCoords.x, startClientCoords.y, 1));

    selectCanvasElement.dispatchEvent(createMouseEvent('mousemove', midClientCoords.x, midClientCoords.y, 1));
    ...
    selectCanvasElement.dispatchEvent(createMouseEvent('mouseup', endClientCoords.x, endClientCoords.y, 1));
