...
describe('Draw Tool', () => {
  ...
  describe('Drawing Behavior with Mouse', () => {
    ...
    it('should not draw if the active layer is not visible', () => {
      ...
      selectCanvasElement.dispatchEvent(createMouseEvent('mousemove', coords.x + charWidth, coords.y));
      selectCanvasElement.dispatchEvent(createMouseEvent('mouseup', coords.x + charWidth, coords.y));
