...
const createMouseEvent = (
  ...
  if (type === 'wheel') return new WheelEvent(type, { clientX, clientY, deltaY, bubbles: true, cancelable: true });
...
describe('Camera Control Tool', () => {
  ...
  describe('Zooming Behaviors', () => {
    ...
    it('should zoom the camera to a specific percentage and request render on "zoom-change::request"', () => {
      ...
      busManager.tools.withTool('camera-control').emit('zoom-change::request', { percentage: targetPercentage });
