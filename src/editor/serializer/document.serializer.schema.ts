import { z } from "zod";
import { CameraSerializableSchema, type CameraSerializableSchemaType } from "./camera.serializer.schema";
import { ConfigSerializableSchema, type ConfigSerializableSchemaType } from "./config.serializer.schema";
import type { HistoryManagerSerializableSchemaType } from "./historyManager.serializer.schema";
import { LayersSerializableSchema, type LayersSerializableSchemaType } from "./layers.serializer.schema";
import { ToolsConfigSerializableSchema, type ToolsConfigSerializableSchemaType } from "./tools.serializer.schema";
